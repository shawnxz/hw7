...
echo "auto-generated by afni_proc.py, Wed Oct 17 01:50:20 2018"
...
cp /scratch/psyc5171/xuz17008/hw7/Finger.txt \
    /scratch/psyc5171/xuz17008/hw7/Foot.txt  \
    /scratch/psyc5171/xuz17008/hw7/Lips.txt $output_dir/stimuli

# copy anatomy to results dir
3dcopy                                                                         \
    /scratch/psyc5171/dataset1/sub-01/ses-test/anat/sub-01_ses-test_T1w.nii.gz \
    $output_dir/sub-01_ses-test_T1w

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 0 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    /scratch/psyc5171/dataset1/sub-01/ses-test/func/sub-01_ses-test_task-fingerfootlips_bold.nii.gz'[0..$]'
...
# (new anat will be intermediate, stripped, sub-01_ses-test_T1w_ns+orig)
align_epi_anat.py -anat2epi -anat sub-01_ses-test_T1w+orig \
...
@auto_tlrc -base MNI_avg152T1+tlrc -input sub-01_ses-test_T1w_ns+orig -no_ss

# store forward transformation matrix in a text file
cat_matvec sub-01_ses-test_T1w_ns+tlrc::WARP_DATA -I > warp.anat.Xat.1D

# ================================= volreg =================================
# align each dset to base volume, align to anat, warp to tlrc space

# verify that we have a +tlrc warp dataset
if ( ! -f sub-01_ses-test_T1w_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: sub-01_ses-test_T1w_ns+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                         \
               sub-01_ses-test_T1w_ns+tlrc::WARP_DATA -I        \
               sub-01_ses-test_T1w_al_junk_mat.aff12.1D -I      \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc
    3dAllineate -base sub-01_ses-test_T1w_ns+tlrc               \
...
3dcopy sub-01_ses-test_T1w_ns+tlrc anat_final.$subj
...
3dAllineate -source sub-01_ses-test_T1w+orig                    \
...
3dresample -master full_mask.$subj+tlrc -input sub-01_ses-test_T1w_ns+tlrc \
...
#
# afni_proc.py -subj_id 01 -script run_afni.sh -scr_overwrite -blocks tshift                          \
#     align tlrc volreg blur mask scale regress -copy_anat                                            \
#     /scratch/psyc5171/dataset1/sub-01/ses-test/anat/sub-01_ses-test_T1w.nii.gz                      \
#     -dsets                                                                                          \
#     /scratch/psyc5171/dataset1/sub-01/ses-test/func/sub-01_ses-test_task-fingerfootlips_bold.nii.gz \
...
#     /scratch/psyc5171/xuz17008/hw7/Finger.txt                                                       \
#     /scratch/psyc5171/xuz17008/hw7/Foot.txt                                                         \
#     /scratch/psyc5171/xuz17008/hw7/Lips.txt -regress_stim_labels finger                             \
